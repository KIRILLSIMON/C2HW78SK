...
public class Truck extends Transport implements Competing {
    ...
    public boolean passDiagnostic() {
        System.out.println("грузовой автомобиль "+getBrand()+getModel()+"НЕ требует диагностики");
        return false;
    }

    @Override
    public void repair() {
        System.out.println("грузовой автомобиль "+getBrand()+getModel()+"НЕ требует ремонта!");
    }
